...
class My_Datasets(Data.Dataset):
    def __init__(self, img_dir, mask_dir, transform1=None,transform2=None):
        ...
        #Initilize a list of all the files in the LGE and mask directories
        self.img_list = os.listdir(self.img_dir)
        self.mask_list = os.listdir(self.mask_dir)

        #Initilize transforms
...
#         % (
    ...
    if epoch_loss_seg_adj < best_seg_loss:
        ...
        torch.save(model_phx.state_dict(), '/content/drive/My Drive/Internship_24_Ryan/Heart/Models/Cine.pt')
...
#In use for colab, downgrade pandas here for use of later evaluation
